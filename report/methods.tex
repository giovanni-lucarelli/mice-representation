...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.68\textwidth]{image/psycho.png}
    \vspace{-0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{image/csf.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{image/mouseimg_2.png}
    \caption{
