...
\begin{table}[h]
    ...
    \begin{tabular}{cccccc}
        \hline
         & \textbf{\texttt{conv1}} & \textbf{\texttt{conv2}} & \textbf{\texttt{conv3}} & \textbf{\texttt{conv4}} &\textbf{\texttt{conv5}} \\
        \hline
        Channels & 64 & 192 & 384 & 256 & 256 \\
        \hline 
        
    \end{tabular}
    \caption{AlexNet convolutional layers architecture. The number of channels in each layer corresponds to the size of the vector of representations of that layer after global average pooling operation.}
